...
<script type="text/javascript">
	...
	function edit_record(id)
	{
		...
		{  
			...
			{   
				...
				$('#cboAgency').val(toIntArray(data.Agency)).change();
	...
	function save_record()
	{
		...
		serialize = $('input').serialize() + "&cboGroupType=" + $('[name="cboGroupType"]').val() + "&cboGroupStatus=" + $('[name="cboGroupStatus"]').val() + "&cboModule=" + $('[name="cboModule"]').val() + "&cboAgency=" + $('[name="cboAgency"]').val();
