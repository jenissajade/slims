...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>plugins/iCheck/all.css">
  <!-- JQuery UI -->
  <link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>scripts/jquery-ui-1.12.1/jquery-ui.min.css">
...
<!-- JQuery UI -->
<script src="<?php echo base_url()."assets/"; ?>scripts/jquery-ui-1.12.1/jquery-ui.min.js"></script>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."acquisitions/"; ?>"><i class="fa fa-circle-o"></i> New Acquisition</a></li>
            <li><a href="<?php echo base_url()."sample/"; ?>"><i class="fa fa-circle-o"></i> Accession Record Book</a></li>
            <li><a href="<?php echo base_url()."monitoring/"; ?>"><i class="fa fa-circle-o"></i> Monitoring of Serial Materials</a></li>
          </ul>
        </li>
      </ul>
    </section>
